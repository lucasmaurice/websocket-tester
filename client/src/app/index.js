      ...
      <div className="parent">
        ...
        <div className="chat-box">
          ...
          <div className="input-container">
            <input className="input" value={this.state.message} name="message" onChange={this.onChange} placeholder="Say Hi!" onKeyPress={this.handleKeyPress} />
            <a className="button" onClick={this.send}>
              Send!
            </a>
          </div>
        </div>
